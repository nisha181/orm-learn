...
public class Options {
	...
	private Set<Attempt_Option> attemptOptionsList;
	public int getId() {
		return id;
	}
	...
	public Set<Attempt_Option> getAttemptOptionsList() {
		return attemptOptionsList;
	}
	public void setAttemptOptionsList(Set<Attempt_Option> attemptOptionsList) {
